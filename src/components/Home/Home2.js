...
import myImg from "../../Assets/Projects/profile.png";
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/AdityaDangi"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/adityadangi07/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="mailto:18adityadangi@gmail.com" // <-- Replace with your email
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
